...
import com.controller.event.EventLoginController;
...
public class Login extends javax.swing.JPanel {
    ...
    private void init() {
        PublicEvent.getInstance().addEventLogin(new EventLoginController() {
            @Override
            public void login(ModelLogin data) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ServiceController.getInstance().getClient().emit("login", data.toJsonObject(), new Ack() {
                            @Override
                            public void call(Object... os) {
                                if (os.length > 0) {
                                    boolean action = (Boolean) os[0];
                                    if (action) {
                                        ServiceController.getInstance().setUser(new ModelUserAccount(os[1]));
            ...
            public void register(ModelRegister data, EventMessageController message) {
                ServiceController.getInstance().getClient().emit("register", data.toJsonObject(), new Ack() {
                    @Override
                    public void call(Object... os) {
                        if (os.length > 0) {
                            ...
                            if (ms.isAction()) {
                                ...
                                ServiceController.getInstance().setUser(user);
                            }
    ...
    private void initComponents() {
        ...
        panelSlide1 = new com.view.swingController.PanelSlide();
        panelSlide2 = new com.view.swingController.PanelSlide();
        pic = new com.view.swingController.PictureBox();
        jLabel2 = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        jPanel1 = new javax.swing.JPanel();
        jPanel2 = new javax.swing.JPanel();
        slide = new com.view.swingController.PanelSlide();
    ...
    private com.view.swingController.PanelSlide panelSlide1;
    private com.view.swingController.PanelSlide panelSlide2;
    private com.view.swingController.PictureBox pic;
    private com.view.swingController.PanelSlide slide;
